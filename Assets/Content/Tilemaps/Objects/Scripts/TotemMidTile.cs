...
[CreateAssetMenu(fileName = "TotemMidTile", menuName = "Tiles/Totem Mid Tile")]
public class TotemMidTile : Tile
{
    public GameObject totemMid;
    
    public override bool StartUp(Vector3Int position, ITilemap tilemap, GameObject go)
    {
        if (Application.isPlaying && totemMid != null)
        {
            ...
            {
                GameObject spikesInstance = Instantiate(totemMid, worldPos, Quaternion.identity);
    ...
    private bool ObjectExistsAtPosition(Vector3 position)
    {
        ...
        return collider != null && collider.gameObject.name == "TotemMid2";
    }
}